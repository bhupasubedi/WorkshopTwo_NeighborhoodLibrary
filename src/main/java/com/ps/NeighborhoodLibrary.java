...
public class NeighborhoodLibrary {
    ...
    public static void main(String[] args) {
        ...
        Book book1 = new Book(1, "9780-12345-678-9", "The Great Adventure", false, "No");
        Book book2 = new Book(2, "9780-23456-789-0", "Mystery at Midnight", true, "Alice");
        Book book3 = new Book(3, "9780-34567-890-1", "A Journey Through Time", false, "No");
        Book book4 = new Book(4, "9780-45678-901-2", "Secrets of the Forest", true, "Bob");
        Book book5 = new Book(5, "9780-56789-012-3", "The Lost City", false, "No");
        Book book6 = new Book(6, "9780-67890-123-4", "Whispers in the Dark", true, "Charlie");
        Book book7 = new Book(7, "9780-78901-234-5", "The Science of Tomorrow", false, "No");
        Book book8 = new Book(8, "9780-89012-345-6", "Art of Deception", true, "Dana");
        Book book9 = new Book(9, "9780-90123-456-7", "Echoes of the Past", false, "No");
        Book book10 = new Book(10, "9780-01234-567-8", "Tales from the Sea", true, "Eve");
        Book book11 = new Book(11, "9780-12345-678-0", "Finding Balance", false, "No");
        Book book12 = new Book(12, "9780-23456-789-1", "The Last Kingdom", true, "Frank");
        Book book13 = new Book(13, "9780-34567-890-2", "Journey of the Mind", false, "No");
        Book book14 = new Book(14, "9780-45678-901-3", "Chasing Dreams", true, "Grace");
        Book book15 = new Book(15, "9780-56789-012-4", "Through the Looking Glass", false, "No");
        Book book16 = new Book(16, "9780-67890-123-5", "The Power of Now", true, "Hannah");
        Book book17 = new Book(17, "9780-78901-234-6", "A World Apart", false, "No");
        Book book18 = new Book(18, "9780-89012-345-7", "Beneath the Surface", true, "Ian");
        Book book19 = new Book(19, "9780-90123-456-8", "Whispers of the Wind", false, "No");
